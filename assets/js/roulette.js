...
//THE SCRIPT 
            ...
            canvas.onclick = function (evt)
            {
                ...
                if(dist <=75 && !stopRoulette){
                    ...
                    // the triangle
                    xctx.beginPath();
                    xctx.moveTo(X, positiontop_triangle); // 75
                    xctx.lineTo(X-sizebottom_triangle, Y); // 19 izquierda
                    xctx.lineTo(X+sizebottom_triangle, Y); // 17
                    xctx.closePath();
                    // the outline
                    xctx.lineWidth = 7;
                    ...
                    xctx.stroke();
                    // the fill color
                    xctx.fillStyle = "#07B946";
                    xctx.fill();                

                    // Circle center 
                    xctx.beginPath();
                    xctx.strokeStyle = "#fff";
                    xctx.fillStyle = "#017C2D";
                    xctx.lineWidth = 5;
                    xctx.arc(X,Y,r,0,2*Math.PI, false);
                    xctx.fill();
                    xctx.stroke();
            ...
            // otg parametro | function invocado al finalizar giros y saber ganador
            var xclosedruleta=false;
            function spinsend()
            {
